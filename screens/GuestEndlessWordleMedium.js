...
const GuestEndlessWordleMedium = () => {
    ...
    const resetGameForNextWord = () => {
      ...
      const persistState = async () => {
        ...
        try{
          ...
          const existingStateString = await AsyncStorage.getItem("@game_endless_Medium_Guest")
          ...
          await AsyncStorage.setItem("@game_endless_Medium_Guest", dataString); 
        } catch (e){
      ...
      {
        const dataString = await AsyncStorage.getItem("@game_endless_Medium_Guest")
        try{
...
export default GuestEndlessWordleMedium
