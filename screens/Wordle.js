...
const Wordle = () => {
  ...
  const onMultiplayerButtonPress = () => {
    // Navigate to the MultiplayerWordle screen
    navigation.navigate('MultiplayerWordle');
  };

  const onCoopButtonPress = () => {
    // Navigate to the MultiplayerWordle screen
    navigation.navigate('LocalCoopWordle');
  };
