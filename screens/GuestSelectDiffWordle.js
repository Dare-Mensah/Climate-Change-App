    ...
    return (
      <LinearGradient style={{flex: 1}} colors={['#EAEAEA', '#B7F1B5']}>
        ...
        <View style={styles.achievementBox}>
          <TouchableOpacity  onPress={() => navigation.navigate("GuestEndlessWordle")}>
        ...
        <View style={styles.achievementBox}>
          <TouchableOpacity  onPress={() => navigation.navigate("GuestEndlessWordleMedium")}>
            <View style={styles.achievementContainer}>
              <Image
        ...
        <View style={styles.achievementBox}>
          <TouchableOpacity  onPress={() => navigation.navigate("GuestEndlessWordleHard")}>
            <View style={styles.achievementContainer}>
              <Image
...
export default GuestSelectDiffWordle
